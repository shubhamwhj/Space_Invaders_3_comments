...
#creating the screen where everyting will be displayed.
screen = pygame.display.set_mode((400,600))

#creating objects of the game (player, emeny ships)
...
while True:    
    ...
    #moving the enemy at x axis
    enemy.x= enemy.x + enemyspeed
    
    #changing enemyspeed to positive or negative on reaching the edge of the screen.
    #making enemy go towards the right.
    if enemy.x == 0:
        enemyspeed=enemyspeed * -1
        enemy.y= enemy.y + 20
    #making enemy go towards the left
    if enemy.x == 380:
        enemyspeed=enemyspeed * -1
        enemy.y= enemy.y + 20
